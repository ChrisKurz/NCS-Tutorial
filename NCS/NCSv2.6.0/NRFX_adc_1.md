...
<sup>SDK version: NCS v2.6.0  -  Link to Hands-on solution: https://github.com/ChrisKurz/hands-on_NCS/tree/main/NCS/Workspace/NRFX_adc</sup>
...
1) Create a new project based on [Creating a Project from Scracth_ exercise](https://github.com/ChrisKurz/hands-on_NCS/blob/main/NCS/DEV_ProjectFromScratch.md).
...
14) Check the output on the Serial Terminal.
   ...
   ![image not found](images/015_terminal.jpg)
