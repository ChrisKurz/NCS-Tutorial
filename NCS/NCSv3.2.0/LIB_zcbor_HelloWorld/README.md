...
1) Create a new application. Use the example _zephyr/samples/hello_world_. Change the project name to __zbor_HelloWorld__ so that you can identify the ZCBOR project more easily later.  
