...
1) Make a copy of the [Creating a Project from Scratch](../DEV_ProjectFromScratch) hands-on and store it in your workspace folder, e.g.  C:/Nordic/Workspace/logging 
