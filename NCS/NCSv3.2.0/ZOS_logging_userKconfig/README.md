...
> _NOTE: You should do first the [Zephyr Logging](../ZOS_logging_uart/README.md) hands-on before doing this course._
...
1) Make a copy of the [Zephyr Logging](../ZOS_logging_uart) project. Store the new project in your workspace folder, e.g. __C:/Nordic/Workspace/logging_kconfig__
