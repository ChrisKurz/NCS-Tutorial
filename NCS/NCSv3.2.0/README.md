...
The _nRF Connect SDK_ version used here is NCS version 3.2.0.
...
- [__CPU Load measurement in software__](ZOS_cpuload_software/README.md) - software reads CPU load measurement value. Measurement is done via software by reading CPU cycles.
...
- [__Hardware Info - Reading Device ID and getting reset cause__](ZHW_hardware_info/README.md)
...
- [__Software Bill of Material: License Report by Nordic__](TOOL_LicenseReport_Nordic/README.md)
- [__Software Bill of Material: License Report by Zephyr__](TOOL_LicenseReport_Zephyr/README.md)
