...
Different devices support different subset of flags. Use <code>hwinfo_get_supported_reset_cause()</code> to retrieve the flags that are supported by that device.
