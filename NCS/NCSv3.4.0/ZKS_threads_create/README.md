...
> __Note:__ The build log shows following warning in the terminal window:
>
> ![image](images/warning.jpg)
>
> Since we are not handling the created thread, the variable <code>my_tid1</code> is not used in the example code. We can ignore this warning.
