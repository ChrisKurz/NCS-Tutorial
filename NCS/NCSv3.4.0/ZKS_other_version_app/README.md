...
1) Make a copy of the [hello_world](../DEV_ProjectFromScratch/README.md) project. 
...
> __Note:__ When you build the project, you will most probably see following warning:
>
> ![image](images/warning.jpg)
>
> There is the __APP_BUILD_VERSION__ symbol in <code>app_version.h</code> file, which holds the output of the Git command <code>git describe --abbrev=12 --always</code> run from the application's repository. This means it reflects the Git-derived version description of the source tree at build time and not the fields defined in __VERSION__ file.
> 
