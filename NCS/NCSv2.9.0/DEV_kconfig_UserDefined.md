<sup>SDK version: NCS v2.9.0  -  Link to Hands-on solution: https://github.com/ChrisKurz/nRF-Connect-SDK-HandsOn/tree/main/Workspace/NCS/NCSv2.9.0/kconfig</sup>
...
_NOTE: You should do first the [Zephyr Logging](https://github.com/ChrisKurz/nRF-Connect-SDK-HandsOn/blob/main/NCS/NCSv2.9.0/ZOS_logging.md) hands-on before doing this course._
...
1) Make a copy of the [Zephyr Logging](https://github.com/ChrisKurz/nRF-Connect-SDK-HandsOn/tree/main/Workspace/NCS/NCSv2.9.0/logging) project. Store the new project in your workspace folder, e.g. __C:/Nordic/Workspace/kconfig__
...
5) Build the project and download to an nRF52 development kit (e.g. nRF54L15DK).
