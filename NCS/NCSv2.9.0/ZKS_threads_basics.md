<sup>SDK version: NCS v2.9.0  -  Link to Hands-on solution: https://github.com/ChrisKurz/nRF-Connect-SDK-HandsOn/tree/main/Workspace/NCS/NCSv2.9.0/threads_create</sup>
...
12) Download the project to the connect nRF52 development board. Use a terminal program to check the debug ouptut. You should see something like this:
   ...
   ![image](images/ZKS_threads_basics/ZKS_Thread_Testing-2_NCSv2.9.0.jpg)
