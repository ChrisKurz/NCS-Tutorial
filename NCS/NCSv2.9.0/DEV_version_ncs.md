<sup>SDK version: NCS v2.9.0  -  Link to Hands-on solution: https://github.com/ChrisKurz/nRF-Connect-SDK-HandsOn/tree/main/Workspace/NCS/NCSv2.9.0/version_ncs</sup>
...
5) In the terminal you should see following outuput:
   ...
   ![image](images/DEV_version_ncs/Ncs_Version_Terminal_NCSv2.9.0.jpg)
