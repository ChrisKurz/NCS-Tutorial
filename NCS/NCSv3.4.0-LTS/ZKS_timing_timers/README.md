...
3) Now we will initialize the timer by calling _k_timer_init()_ function: 
  ...
  <sup>_src/main.c_ => main() function</sup>   
   ...
   <sup>https://docs.nordicsemi.com/bundle/ncs-3.4.0/page/zephyr/kernel/services/timing/timers.html#c.k_timer_init</sup>
...
4) In the timer initialization we also defined a callback function, which should be called as soon as the timer expires. So we have to add this function.
  ...
  <sup>_src/main.c_</sup>   
   ...
   <sup>https://docs.nordicsemi.com/bundle/ncs-3.4.0/page/zephyr/kernel/services/timing/timers.html#c.k_timer_stop</sup>
...
6) The timer was not yet started. This is done with following line:
  ...
  <sup>_src/main.c_ => main() function</sup>   
   ...
   <sup>https://docs.nordicsemi.com/bundle/ncs-3.4.0/page/zephyr/kernel/services/timing/timers.html#c.k_timer_start</sup>
