...
> - To inspect the full initialization sequence order, you can also run <code>west build -d build\hello_world -t initlevels</code> in your project folder or used the _nRF Connect_ Extension __Core overview | Initialization levels__. 
...
4) Use a scope and check the RESET input and Debug pin. Here is an example for Zephyr*s _hello world_ sample.
   ...
   Here are the measurement results for the _hello world_ project running on nRF54L15:
