...
1) Create a new project based on [LPS22HB project](../ZDD_sensor_lps22hb_nrf54LM20dk)
...
> __Note:__ CONFIG_GPIO is usually enabled by default. CONFIG_SHELL and CONFIG_I2C was already enabled in previous sample code.
