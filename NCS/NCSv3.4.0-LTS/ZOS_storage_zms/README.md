...
8) ZMS needs a flash area where it stores data. We use one of the available fixed flash partitions. The <code>storage_paritition</code> exists in the nRF54L15DK board DTS configuration.
