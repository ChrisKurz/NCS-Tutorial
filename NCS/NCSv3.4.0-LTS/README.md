...
- [__Defining own KCONFIG symbols that depends on nRF Connect SDK Version__](DEV_kconfig_userDefined_NCSversion/README.md)
...
- [__Using Zephyr Memory Storage (ZMS)__](ZOS_storage_zms/README.md)
