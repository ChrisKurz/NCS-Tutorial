<sup>SDK version: NCS v2.3.0  -  Link to Hands-on solution: https://github.com/ChrisKurz/Bluetooth/tree/main/Workspace/NCSv2.3.0/01_Beacon</sup>
...
1) Create the project folder in your own Workspace directory. Example:    c:/MyWorkspace/01_Beacon
