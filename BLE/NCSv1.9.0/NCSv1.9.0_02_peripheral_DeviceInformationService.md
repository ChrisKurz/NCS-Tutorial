...
Notes: 
- The prj.conf file contains lines that are commented out. These have been added to allow a better understanding of the setting options and the used setting. Note that CONFIG_BT_BROADCASTER is by default 'y'. 
...
5) Build the project and download to an nRF52-DK or nRF52840-DK.
6) Use a smartphone and the nRF Connect app and look for "DIS peripheral" device. Check the GATT database.
