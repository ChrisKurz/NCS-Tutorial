...
1) Make a copy of the project "Peripheral with DIS service". 

   If you haven't done the this hands-on exercise, you can also download the Custom Service project [here](../peripheral_service_DIS/README.md).
...
![image](images/smartphone_scan.jpg)
...
![image](images/smartphone_connected.jpg)
...
![image](images/terminal_PhyUpdate.jpg)
