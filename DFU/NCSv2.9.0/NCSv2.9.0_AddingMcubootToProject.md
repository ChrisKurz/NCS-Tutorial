...
1) Create a new application based on the /zephyr/samples/hello_world sample project. (e.g. name of new project: "01_MCUboot1")
   ...
   ![missing image](images/mcuboot_AddToProject/HO1-buildConf_mcuboot1_NCSv2.9.0.jpg)
...
8) In the Programmer you should see two blocks:
   ...
   ![missing image](images/mcuboot_AddToProject/HO1-programmer_mcuboot1_NCSv2.9.0.jpg)
...
10) When programming is completed, check the Terminal output. 
   ...
   ![missing image](images/mcuboot_AddToProject/HO1-terminal_mcuboot1_NCSv2.9.0.jpg)
